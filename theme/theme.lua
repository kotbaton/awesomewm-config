...
theme.border_focus  = theme.colors.white
...
-- taglist
theme.taglist_fg_focus                          = theme.colors.black
theme.taglist_bg_focus                          = theme.colors.white
...
theme.tasklist_fg_minimize                      = theme.colors.darkgrey
theme.tasklist_fg_urgent                        = theme.colors.black
theme.tasklist_bg_normal                        = theme.colors.black
theme.tasklist_bg_focus                         = theme.colors.black
...
theme.tasklist_shape_border_color               = theme.colors.grey
-- theme.tasklist_shape_focus                   = nil
-- theme.tasklist_shape_border_width_focus      = nil
theme.tasklist_shape_border_color_focus         = theme.colors.white
-- theme.tasklist_shape_minimized               = nil
-- theme.tasklist_shape_border_width_minimized  = nil
theme.tasklist_shape_border_color_minimized     = theme.colors.darkgrey
-- theme.tasklist_shape_urgent                  = nil
-- theme.tasklist_shape_border_width_urgent     = nil
theme.tasklist_shape_border_color_urgent        = theme.colors.black

-- notification
theme.notification_font                         = "Ubuntu Bold 12"
theme.notification_bg                           = theme.colors.l_aqua .. "bb"
theme.notification_fg                           = theme.colors.black
theme.notification_border_color                 = theme.colors.l_aqua
...
-- snap
theme.snap_bg           = theme.colors.l_aqua
...
theme.tray_icon = theme_path.."icons/tray.png"
